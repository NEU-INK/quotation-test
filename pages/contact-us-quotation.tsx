...
const ContactUs = () => {
  return (
    <>
      <Head>
        <title>Contact Us Quotation | Walt Tec | Get in Touch</title>
        <meta
          name="description"
        ...
        {/* Open Graph Metadata */}
        <meta property="og:title" content="Contact Us Quotation | Walt Tec | Get in Touch" />
        <meta
        ...
        <meta name="twitter:title" content="Contact Us Quotation | Walt Tec | Get in Touch" />
        <meta
        ...
        <link rel="canonical" href="https://walttec.shop/contact-us-quotation/" />
