...
const partnersList = [
  {
    ...
    data: [
      // Carousel 显示的具体内容
      {
        ...
        description:
          '“Hi! I just received the socks! First, the material is incredible on both sock types. Thank you!” ', // 描述信息
  ...
  },
  {
    ...
    data: [
      // Carousel 显示的具体内容
      {
        ...
        description:
          '"Hello,I\'ve received the samples. They look amazing, thank you. \n' +
  ...
  },
  {
    ...
    data: [
      // Carousel 显示的具体内容
      {
        ...
        title: 'NIKE', // 显示的标题
        description:
          '“We will put the athlete* at the center of everything we do,\n' +
  ...
  },
  {
    ...
    data: [
      // Carousel 显示的具体内容
      {
        ...
        title: 'BOMBAS', // 显示的标题
        description:
          '"Small things matter. They add up. Then, they turn into big \n' +
...
const OurPartners = () => {
  ...
  const handleMouseEnter = (index: any) => setSelectedPartner(index)
          ...
          <Box display="flex" justifyContent="space-around" mb={4} padding={'0 15%'}>
            {partnersList.map((partner, index) => (
              <Typography
                ...
                style={{
                  cursor: 'pointer',
                  color: selectedPartner === index ? '#ADD8E6' : 'var( --base-blue)',
                }}
