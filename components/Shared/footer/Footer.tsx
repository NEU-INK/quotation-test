    ...
    return (
        <Box className={styles.footerContainer}>
            ...
            <Box className={styles.footerTitle}>
                <Link href="/" className={styles.footerTitleLink}>
                    <Box>
                        <Image src={logoWaltTEC.src}  width={211.8} height={50.3}   className={styles.footerTitleImg} alt={siteName} />
                    </Box>
            ...
            <Container maxWidth="xl">
                ...
                <Box className={styles.copyright}>
                    <Typography fontSize={`${isMobile?'2.4rem':'1.8rem'}`} >
                        {copyright.split(' ')[0]}&nbsp; {copyright.split(' ').splice(1).toString().replaceAll(',', ' ')}
                    </Typography>
                </Box>
            </Container>
        </Box>
