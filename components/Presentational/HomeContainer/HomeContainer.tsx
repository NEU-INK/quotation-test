...
// import HomeShoppingCart from '../../../public/icons/walt/home-shopping-cart.png';
const HomeContainer = () => {
    ...
    return (
        <Box position="relative" style={{ backgroundColor: '#003680' }} >
            <Slider {...settings}  >
                {/* 使用图片作为图标 */}
                        ...
                        <Box position="relative" width="100%" height="100%">
                            ...
                            {index=== 1 ? (
                                ...
                                <Box position="absolute" bottom="15%" left="6%" color="white">
                                    ...
                                    <Typography fontSize={`${isMobile?'4rem':'8.2rem'}`} lineHeight={1} fontWeight={800} style={{ fontWeight: 'bold' }}>
                                        {video.text1}<br/>{video.text2}<br/>{video.text3}
                                    </Typography>
                                ...
                                <Box position="absolute" bottom="15%" left="6%" color="white">
                                    ...
                                    <Typography fontSize={`${isMobile?'4rem':'8.2rem'}`} lineHeight={1.5} fontWeight={800} style={{ fontWeight: 'bold' }}>
                                        {video.header}
                                    </Typography>
