...
import styles from './AboutUsGlobalPresence.module.scss'
import Slider from 'react-slick'
import { useDevice } from '../../../utils/deviceContext'

const AboutUsGlobalPresence = () => {
  ...
  const handleMouseEnter = (id: any) => setSelectedPoint(id)
              ...
              <Image
                src={
                  selectedPoint === point.id
                    ? '/images/walt/mark-red.png'
                    : '/images/walt/mark-blue.png'
                }
                alt={point.label}
                width={25}
                height={30}
          ...
          {pointsText.map((point: any) => (
            <Box
              ...
              sx={{
                ...
                color: selectedPoint === point.id ? '#8DB7D9' : 'var(--base-blue)',
          ...
          {pointsLine.map((point) => (
            <Box
              ...
              sx={{
                ...
                borderRight:
                  point.type === 2
                    ? `1px dashed ${selectedPoint === point.id ? '#8DB7D9' : 'var(--base-blue)'}`
                    : 'none',
                borderTop:
                  point.type === 1
                    ? `1px dashed ${selectedPoint === point.id ? '#8DB7D9' : 'var(--base-blue)'}`
                    ...
                    <Box className={styles.modalContentTextTop}>
                      ...
                      >
                        <Typography
                          ...
                          fontFamily={'HS'}
                          fontWeight={700}
                          color={item.text ? '#fff' : 'var(--base-blue)'}
                        >
                          {item.title}
                        </Typography>
                        <Typography
                          fontFamily={'HS'}
                          fontSize={`${isMobile ? '2.2em' : '2.6rem'}`}
                          color={item.text ? '#fff' : 'var(--base-blue)'}
                        >
                          {item.location}
                        </Typography>
...
export default AboutUsGlobalPresence
