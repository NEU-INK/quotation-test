          ...
          >
            ...
            <Box className={styles.cardRight}>
              <Typography
                ...
                sx={{ fontWeight: 'Bold', lineHeight: 2, fontFamily: 'HS' }}
                align={item.type === 2 ? 'right' : 'left'}
                color={'var(--base-blue)'}
              >
                {item.title}
              </Typography>
              ...
              <Box key={index} className={styles.valuesImgCard}>
                ...
                <Box className={styles.valuesImgText}>
                  <Typography
                    ...
                    sx={{ lineHeight: 1.4, fontFamily: 'HS', textAlign: 'center' }}
                  >
                    {item.title}
                  </Typography>
                </Box>
